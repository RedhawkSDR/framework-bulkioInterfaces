...
class BaseMultiOut(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.desc_list.append( bulkio.OutPort.connection_descriptor_struct( "multiout_source", "connection_1", "stream-1-1" ) )
        self.desc_list.append( bulkio.OutPort.connection_descriptor_struct( "multiout_source", "connection_1", "stream-1-2" ) )
        self.desc_list.append( bulkio.OutPort.connection_descriptor_struct( "multiout_source", "connection_1", "stream-1-3" ) )
        self.desc_list.append( bulkio.OutPort.connection_descriptor_struct( "multiout_source", "connection_2", "stream-2-1" ) )
        self.desc_list.append( bulkio.OutPort.connection_descriptor_struct( "multiout_source", "connection_2", "stream-2-2" ) )
        self.desc_list.append( bulkio.OutPort.connection_descriptor_struct( "multiout_source", "connection_2", "stream-2-3" ) )
        self.desc_list.append( bulkio.OutPort.connection_descriptor_struct( "multiout_source", "connection_3", "stream-3-1" ) )
        self.desc_list.append( bulkio.OutPort.connection_descriptor_struct( "multiout_source", "connection_3", "stream-3-2" ) )
        self.desc_list.append( bulkio.OutPort.connection_descriptor_struct( "multiout_source", "connection_3", "stream-3-3" ) )
        self.desc_list.append( bulkio.OutPort.connection_descriptor_struct( "multiout_source", "connection_4", "stream-4-1" ) )
